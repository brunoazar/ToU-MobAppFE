  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomNavigation}>
        {/* Pending Orders */}
          <TouchableOpacity style={styles.bottomNavigationButton} onPress={() => handleNavigation('PendingOrdersScreen2')}>
        ...
        {/* Active Orders */}
        <TouchableOpacity style={styles.bottomNavigationButton} onPress={() => handleNavigation('ActiveOrdersScreen2')}>
        ...
        {/* Paste Link */}
        <TouchableOpacity style={styles.bottomNavigationButton} onPress={() => handleNavigation('TravelerMainScreen')}>
        ...
        {/* Settings */}
        <TouchableOpacity style={styles.bottomNavigationButton} onPress={() => handleNavigation('TravelerSettingsScreen')}>
